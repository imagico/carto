            ...
            if (parents.length) {
                for (j = 0; j < parents.length; j++) {
                    ...
                    if (parent.attachment && child.attachment) {
                        ...
                        // we don't want to construct new styles based on mixed attachments.
                        // instead: if they match use it, if they do not discard
                        if (parent.attachment === child.attachment) clone.attachment = child.attachment
                        else continue;
                    }
